			...
			$.ajax({
			    ...
			    success:function(data){
			    	if(data.result == 'SUCCESS') {
			    		alert("성공적으로 등록되었습니다.");
						location.href = 'boardDetail?boardSeq=' + data.boardSeq;
			    	}
			    }
			});
		}
            ...
            <div>
                ...
                <div class="write">
                    <dl>
                        ...
                        <dd>
                            <input type="text" id="boardTitle" name="boardTitle" autocomplete="off" id="entitle01" placeholder="제목을 입력해주세요" value="" />
                        </dd>
                    </dl>
                    <dl>
                        <dt>내용</dt>
                        <dd>
                            <textarea id="boardText" name="boardText" title="내용" placeholder="내용을 작성해 주세요."></textarea>
                        </dd>
                    </dl>
                </div>
                <div class="btn03">
                    <a id="cancelBtn" href="#">취소</a>
                    <button id="insertBtn" type="submit">등록</button>
                </div>
            </div>
		</div>
		<!-- //Container -->
